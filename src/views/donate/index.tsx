...
export const DonateView = ({ setOpenSendTransaction }) => {
  ...
  const onClick = useCallback(async () => {
    ...
    const creatorAddress = new PublicKey(
      ...
      "4tFTSSmexaJjdfpTyUZamoDXtGyXnSK3nKAgP6AmyDZs"
    );
    ...
    try {
      ...
      notify({
        message: `You have successfully trnsfered Funds ${amount}`,
        type: "success",
        txid: signature,
      });
      ...
      getUserSOLBalance(publicKey, connection); // Update balance
    } catch (error: any) {
      notify({
              ...
              <div className="lg:ps-0 flex h-full flex-col p-10">
                ...
                <div className="my-auto pb-6 text-center">
                  ...
                  <p className="text-default-300 mx-auto mb-5 max-w-sm">
                    Now you can donate to the creator of this project by sending
                  </p>
