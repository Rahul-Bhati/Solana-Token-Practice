      ...
      <header id="navbar-sticky" className="navbar">
        <div className="container">
          <nav>
            ...
            <div className="ms-auto flex item-center px-2.5 lg:hidden">
              <button
            ...
            <div
              id="mobileMenu"
              className="hs-collapse hidden mx-auto mt-2 grow basis-full item-center justify-center transition-all duration-300 lg:mt-0 lg:flex lg:basis-auto"
            >
