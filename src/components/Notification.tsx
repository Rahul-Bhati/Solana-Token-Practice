      ...
      <div className="p-4">
        <div className="flex items-center">
          <div className="flex-shrink-0">
            {type === "success" ? (
              <CheckCircleIcon className="text-success mr-1 w-8 h-8" />
            ) : null}
            {type === "info" ? (
              <InformationCircleIcon className="text-info mr-1 w-8 h-8" />
            ) : null}
            {type === "error" ? (
              <XCircleIcon className="text-error mr-1 w-8 h-8" />
            ) : null}
          </div>
